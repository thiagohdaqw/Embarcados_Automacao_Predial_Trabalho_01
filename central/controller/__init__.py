...
def init(app: router.HttpRouter):
    ...
    app.register_route(router.HttpMethod.GET, '/api/buildings/feedbacks', buildings.get_feedbacks)
    ...
    app.register_route(router.HttpMethod.POST, '/api/rooms/relays/toggle', rooms.toggle_relay)